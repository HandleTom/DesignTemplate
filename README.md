...
![Alt text](/img/behaviorModel/Command.jpg "Observer title")
...
![Alt text](/img/behaviorModel/Memento.jpg "Observer title")
...
![Alt text](/img/behaviorModel/State.jpg "Observer title")
...
![Alt text](/img/behaviorModel/Visitor.jpg "Observer title")
...
![Alt text](/img/behaviorModel/Mediator.jpg "Observer title")
...
![Alt text](/img/behaviorModel/Interpreter.jpg "Observer title")
* Context类是一个上下文环境类，Plus和Minus分别是用来计算的实现



### 总结：到今日（2017-11-29）总算是将设计模式囫囵吞枣般的学习了一次；看的有些迷迷糊糊，需要在后来漫长的道路上再进行更深层的领域与理解。自身在关键字extend、interface、abstract、私有化注入对象的等方面还是需要加强训练，好有更深入的理解。切不可妄言；要相信人外有人，山外有山。要有更深入的学习与领悟。
